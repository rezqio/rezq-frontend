...
const TermsAndConditions = () => (
  <div className="section-container">
    <div className="section-body" style={{ marginBottom: 100 }}>
...
By accessing this website we assume you accept these terms and conditions
      in full. Do not continue to use RezQ&#39;s website if you do not accept all of
...
The following terminology applies to these Terms and Conditions, Privacy
      ...
      any other means, for the express purpose of meeting the Client&#39;s needs
      in respect of provision of the Company&#39;s stated services/products, in
      accordance with and subject to, prevailing law of Canada. Any use of the above
      ...
      same.
        ...
        <p>
We employ the use of cookies. By using RezQ&#39;s website you consent to the
      use of cookies in accordance with RezQ&#39;s
          {' '}
...
.
        ...
        <p>
Unless otherwise stated, RezQ and/or it&#39;s licensors own the
      intellectual property rights for all material on RezQ. All intellectual
      property rights are reserved. You may view and/or print pages from
      https://rezq.io/ for your own personal use subject to restrictions set in
      these terms and conditions.
        ...
        <ol>
          <li>Republish material from https://rezq.io/</li>

          <li>Sell, rent, or sub-license material from https://rezq.io/</li>

          <li>Reproduce, duplicate, or copy material from https://rezq.io/</li>

          <li>
Redistribute content from RezQ (unless content is specifically made for
          redistribution).
          </li>
        </ol>
...
Certain parts of this website offer the opportunity for users to post
        and exchange opinions, information, material, and data (&quot;Comments&quot;) in areas
        of the website. RezQ does not screen, edit, publish, or review Comments
        prior to their appearance on the website and Comments do not reflect the
        views or opinions of RezQ, its agents or affiliates. Comments reflect the
        view and opinion of the person who posts such view or opinion. To the
        extent permitted by applicable laws RezQ shall not be responsible or liable
        for the Comments or for any loss cost, liability, damages, or expenses
        caused and/or suffered as a result of any use of and/or posting of and/or
        appearance of the Comments on this website.
          </li>

          <li>
RezQ reserves the right to monitor all Comments and to remove any
...
Online directory distributors when they list us in the directory
            may link to our Web site in the same manner as they hyperlink to the
...
We will approve link requests from these organizations if we determine
      ...
      visibility associated with the hyperlink outweighs the absence of the hyperlink;
      and (d) where the link is in the context of general resource information or
      is otherwise consistent with editorial content in a newsletter or similar
...
These organizations may link to our home page, to publications, or to other
      ...
      linking party and it products or services; and (c) fits within the context of
...
. Please include your
      name, your organization name, contact information (such as a phone number
      and/or email address) as well as the URL of your site, a list of any URLs
      from which you intend to link to our Web site, and a list of the URL(s) on
      our site to which you would like to link. Allow 2-3 weeks for a response.
        </p>
...
By use of any other description of our Web site or material being
        ...
        <p>
No use of RezQ&#39;s logo or other artwork will be allowed for linking
...
We reserve the right at any time and in its sole discretion to request
      that you remove all links or any particular link to our Web site. You agree
      to immediately remove all links to our Web site upon such request. We also
...
We shall have no responsibility or liability for any content appearing on
      ...
      arising out of or based upon your Web site. No link(s) may appear on any page
...
If you find any link on our Web site or any linked web site objectionable
      for any reason, you may contact us about this. We will consider requests to
...
This Terms and conditions page was created at
      ...
      termsandconditionstemplate.com
          ...
          {' '}
generator. If you have any queries regarding any of
      our terms, please contact us via email at
          {' '}
          <a href="mailto:support@rezq.io">support@rezq.io</a>
.
        </p>
